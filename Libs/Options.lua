...
function ZGV:Options_DefineOptionTables()
	...
	AddOptionGroup("main","","zygor",{  name = L["name"].." - |cff9C2542Installed by|cffE0218A: |cff00FFFFZygor Updates Improved", desc = L["desc"],  },true)
	do
		...
		AddOption('',{ type = "description", name = function()
			...
			s=s.."\n".."|cff9C2542Zygor Updater Link|cffE0218A: |cff00FFFFTiny.cc/zygorupdates".."\n"
			return s
		end})
...
-- 			_default = 0.5,
	...
	do
		AddOptionSep()
		AddOption('autogear',{ type = 'toggle',width="full", _default=true, set = function(i,v) Setter_Simple(i,v)  ZGV.ItemScore.AutoEquip:Toggle() end, descStyle="inline"})
