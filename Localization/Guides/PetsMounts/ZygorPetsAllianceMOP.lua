...
|confirm
step
goto The Jade Forest 58.9,81.7
.talk 60970
..accept 29903
step
goto 59.1,84.52
...
step
label "create"
'You have to complete the Dailies for the _Golden Lotus_ and open _Treasures of the Vale_ (quest rewards)to get the recipe for this pet.
...
|confirm
step
goto Vale of Eternal Blossoms/0 86.6,60.0
.talk 64572
..accept 32428
...
pet 1128
step
.' In order to get this pet, you will need to collect _Domination Point Commissions_.
...
step
goto Krasarang Wilds 77.4,27.8
.from Domination Point Raider##67826+, Dominance Grunt##67357+, Dominance Shaman##67520+
.' You can find more enemies to kill around [goto Krasarang Wilds 11.7,64.5]
.from Dominance Battlemage##67330+, Dominance Raider##67346+, Heavy Mook##67399+, Dominance Grunt##67357+, Bloodhilt Honorguard##67334+
.collect 2000 Domination Point Commission##91877
step
label buy
goto Krasarang Wilds 89.5,33.5
.talk 67881
...
pet 1182
step
goto Isle of Thunder 55.3,70.8
...
pet 1181
step
goto Isle of Thunder 51.8,63.8
.' The _Elder Python_ are around level 25 and share a spawn with Thundertail Flappers and Swamp Croakers.
..' Challenge one to a pet battle and capture it.
